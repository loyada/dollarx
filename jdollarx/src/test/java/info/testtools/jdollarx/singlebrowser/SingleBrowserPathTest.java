...
import static info.testtools.jdollarx.singlebrowser.SingleBrowserPath.div;
import static info.testtools.jdollarx.singlebrowser.SingleBrowserPath.span;
...
public class SingleBrowserPathTest {
    ...
    public void setup() {
        ...
        when(((HasInputDevices) InBrowserSinglton.driver).getMouse()).thenReturn(mouseMock);
        when(((HasInputDevices) InBrowserSinglton.driver).getKeyboard()).thenReturn(keyboardMock);
