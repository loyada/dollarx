...
public class ElementPropertiesTest extends XPathTester{
    ...
    public void isLast() {
        ...
        assertThat(nodes.getLength(), is(2));
        assertThat(getElemenName(nodes.item(0)), equalTo("span"));
        assertThat(getElemenName(nodes.item(1)), equalTo("b"));
    ...
    public void hasNoChildren() {
        ...
        assertThat(getElemenName(nodes.item(0)), equalTo("x"));
        assertThat(getElemenName(nodes.item(1)), equalTo("div"));
        assertThat(getElemenName(nodes.item(2)), equalTo("a"));
        assertThat(getElemenName(nodes.item(3)), equalTo("b"));
    ...
    public void hasTextTest() {
        ...
        assertThat(getElemenName(nodes.item(0)), equalTo("div"));
    ...
    public void hasAnyOfClassesTest() {
        ...
        assertThat(getElemenName(nodes.item(1)), equalTo("span"));
    ...
    public void notTest() {
        ...
        assertThat(nodes.getLength(), is(2));
        assertThat(getElemenName(nodes.item(0)), equalTo("html"));
